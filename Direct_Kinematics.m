function T_solved = Direct_Kinematics(q0)
   ...
   q = [q0(1) q0(2)-pi/2 q0(3) q0(4) q0(5) q0(6)]; %Set rotations;
  ...
  %Plotting
   ...
   alpha = rad2deg(alpha);
   q = rad2deg(q);
   T_solved = FK(q, alpha, DH1, DH2, DH3, DH4, DH5, DH6);
