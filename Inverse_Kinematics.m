function q = Inverse_Kinematics(T)
   ...
   theta1 = round(theta1,4);
    ...
    %Fixed axis. Needed for model. It doesn't matter and doesn't move
    theta4 = round(0); 
...
%Calculating the Homogeneous matrix from 0 to 4. 
   alpha = rad2deg(alpha);
   q = rad2deg(q);
A04 = HRot('z',q(1))*transl(0,0,DH1(2))* transl(DH1(3),0,0)*HRot('x',alpha(1))* ...
...
%Calculating the Homogeneous matrix from 4 to 6. 
    ...
    theta5 = pi-atan2(T46(2,2), T46(1,2));
    theta6 = atan2(sqrt(1-T46(3,2)^2),T46(3,2));
    theta7 = atan2(T46(3,3), (T46(3,1)));
    
    theta5 = zero_el(theta5);
    theta6 = zero_el(theta6);
    theta7 = zero_el(theta7);
    ...
    q0 = [zero_el(theta1) zero_el(theta2+pi/2) zero_el(theta3) 0 theta5 theta6 theta7];
    q = vpa(q0);
   q0 = [zero_el(theta1) zero_el(theta2+pi/2)-pi/2 zero_el(theta3) 0 theta5 theta6 theta7];
   %Plotting
   alpha = [-pi/2 0 -pi/2 0 -pi/2 pi/2 pi/2];   
   ...
   DH6 = [q0(6)	0	0	alpha(6)];
   DH7 = [q0(7)	L5	0	alpha(7)];   
